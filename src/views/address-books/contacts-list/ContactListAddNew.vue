      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <b-form-textarea
                ...
                placeholder="Describe what this contact contains"
                rows="2"
              />
              <b-form-invalid-feedback>
                {{ validationContext.errors[0] }}
          ...
          >
            ...
            >
              <b-form-tags
                v-model="contactData.custom_fields"
                input-id="custom-fields"
                placeholder="Add a custom Field"
                class="mb-2"
              />
              <p> Custom Fields: {{ contactData.custom_fields }}</p>
              <b-form-invalid-feedback>
                {{ validationContext.errors[0] }}
              </b-form-invalid-feedback>
            </b-form-group>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const onSubmit = () => {
      store.dispatch('address-books/addContact', contactData.value)
        .then(() => {
          emit('refetch-data')
